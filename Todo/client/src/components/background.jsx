    ...
    return (
        <>
            <div className='fixed z-[2] w-full h-screen'>
                <h1 className='absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-[8vw] leading-none tacking-tighter font-Roboto font-semibold text-zinc-300'>Daily Tracker.</h1>
